# telemetry/management/commands/rollup_1m_to_5m.py
...
class Command(BaseCommand):
    help = 'Roll up 1-minute telemetry data to 5-minute buckets'
    ...
    def handle(self, *args, **options):
        """Execute the rollup"""
        self.stdout.write("🔄 Starting 1-minute to 5-minute rollup...")
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(
                f"✅ 1m-to-5m rollup completed successfully"
            ))
